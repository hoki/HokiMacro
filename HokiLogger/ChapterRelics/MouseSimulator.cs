...
namespace ChapterRelics
{
    ...
    public static class MouseSimulator
    {
        ...
        /// </summary>
        /// <param name="button"></param>
        public static void MouseDownButtonParser(MouseButtons button)
        {
            switch (button)
            {
        ...
        /// </summary>
        /// <param name="button"></param>
        public static void MouseUpButtonParser(MouseButtons button)
        {
            switch (button)
            {
                case MouseButtons.Left:
        ...
        /// </summary>
        /// <param name="button"></param>
        public static void ClickButtonParser(MouseButtons button)
        {
            switch (button)
            {
                case MouseButtons.Left:
        ...
        /// </summary>
        /// <param name="button"></param>
        public static void DoubleClickButtonParser(MouseButtons button)
        {
            switch (button)
            {
                case MouseButtons.Left:
